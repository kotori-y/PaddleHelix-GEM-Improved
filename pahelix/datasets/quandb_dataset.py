...
def get_default_quandb_task_names():
    """Get that default freesolv task names and return measured expt"""
    return ['eHOMO', 'eLUMO', 'mu', 'density', 'nu']


def load_quandb_dataset(data_path, task_names=None):
    if task_names is None:
        task_names = get_default_quandb_task_names()
...
def get_quandb_stat(data_path, task_names):
